...
router.post('/register/step1', isLoggedIn, can('workers:create'), step1Rules, ctrl.saveStep1);
router.get('/register/step2', isLoggedIn, can('workers:create'), ctrl.showStep2);
router.post('/register/step2', isLoggedIn, can('workers:create'), step2Rules, ctrl.saveStep2);
router.get('/register/step3', isLoggedIn, can('workers:create'), ctrl.showStep3);
router.post('/register/step3', isLoggedIn, can('workers:create'),
  workerUpload.fields([
